    ...
    <div className="pub-site">
      ...
      <section className="pub-hero">
        ...
        <div className="hero-photo-stack">
            <div>
              <img src={logoPahaba} alt="Cafe interior 1" className="hero-photo" />
            </div>
            <div>
              <img src={fruitTea} alt="Cafe interior 2" className="hero-photo" />
            </div>
            <div>
              </div>
        </div>
        ...
        <div className="about-container">
          ...
          <div className="about-right">
            <div className="about-gallery">
              <img src={aboutImg1} alt="Cafe interior 1" className="about-image" />
              <img src={aboutImg2} alt="Cafe interior 2" className="about-image" />
              <img src={aboutImg3} alt="Cafe interior 3" className="about-image" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="menu-section" className="pub-menu" ref={menuRef}>
        <div className="menu-header-block">
          ...
          <div className="menu-big-title">
            <img src={menuImg} alt="Menu" className="menu-image" />
          </div>
        </div>
      ...
      <footer className="pub-footer">
        <div className="footer-inner">
          <div className="footer-brand">
            <img src={logo} alt="Mugshot Cafe Logo" className="footer-logo" />
            <div>
